...
document.addEventListener("DOMContentLoaded", function () {
    const cardsWrapper = document.getElementById("employeeDetails");
    cardsWrapper.setAttribute("datasource", JSON.stringify(employeeData));
    const cardsWrapper2 = document.getElementById("employeeDetails2");
    cardsWrapper2.setAttribute("datasource", JSON.stringify(employeeData2));

    document.getElementById("deleteCard").addEventListener("click", deleteFirstCard);
});
