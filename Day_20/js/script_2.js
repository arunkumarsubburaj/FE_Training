import { filterCards, cardConfig } from "./card_fn.js";
...
document.addEventListener("DOMContentLoaded", function () {
    var wrapper = document.getElementById("employeeDetails");
    var filterInputEle = document.getElementById("filterInput");
    cardConfig["searchValue"] = searchValue;
    cardConfig["employeeData"] = employeeData;
    cardConfig["wrapper"] = wrapper;
    cardConfig["filteredEmpData"] = filteredEmpData;
    cardConfig["filterInputEle"] = filterInputEle;
    filterCards(true);
});
